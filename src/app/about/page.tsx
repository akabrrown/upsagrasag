...
import { Info, Target, Landmark, FileText, Download } from 'lucide-react';
    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 space-y-12 bg-background text-foreground">
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-5 rounded-2xl bg-[#003366] p-6 border border-[#003366] text-white shadow-lg space-y-4">
          <h3 className="font-bold text-sm text-accent flex items-center gap-1.5">
          ...
          <a
            href="#"
            className="inline-flex items-center justify-center gap-1.5 rounded-xl bg-accent hover:bg-accent/90 text-white px-4 py-2.5 text-xs font-bold transition-all duration-200 cursor-pointer w-full text-center"
          >
