      ...
      <div className="space-y-8">
        ...
        <Card className="p-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-slate-800">President Records</h2>
            <button
              onClick={openCreate}
        ...
        <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={editingId ? 'Edit President Info' : 'Create President Info'}>
