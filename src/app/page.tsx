          ...
          <div className="lg:col-span-4 hidden md:flex items-end justify-end gap-3 pb-2 w-full">
            {slides.map((slide, idx) => (
              <button
                ...
                className={`relative w-[110px] h-[75px] rounded-lg overflow-hidden border shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer ${slideIndex === idx
        ...
        <section className="w-full relative overflow-hidden bg-slate-950 h-[405px] sm:h-[486px] flex flex-col justify-end">
          <div className="absolute inset-0">
            {events.map((event, idx) => (
              ...
              >
                <Image src={event.image_url || '/bkg-grasag.jpg'} alt={event.title} fill className="object-contain object-right md:object-center opacity-40 md:opacity-90" />
